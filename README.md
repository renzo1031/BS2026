<h1 align="center">🎓 BS2026 校园信息系统项目合集</h1>

<p align="center">
  基于 <strong>Spring Boot + Vue</strong> 的校园信息系统项目合集<br>
...
```powershell
# 1. 初始化数据库
cmd /c "mysql -uroot -proot < sql\002\init.sql"
...
# 3. 启动后端
Set-Location ".\002-backend"
mvn spring-boot:run

# 4. 另开终端启动前端
Set-Location ".\002-frontend"
npm install
npm run dev
```
